...
import {nearlyEquals, isBetween, roundTo, square, clamp, lerp, quadratic} from './arithmetic';
...
export class Ellipse {
  ...
  // TODO Add rotate, reflect, scale, shift, translate, contains, equals methods
